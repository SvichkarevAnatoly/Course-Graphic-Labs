...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DrawPanel_t, stringdata) + ofs \
...
const QMetaObject DrawPanel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DrawPanel.data,
      qt_meta_data_DrawPanel,  qt_static_metacall, 0, 0}
};
...
void *DrawPanel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Canvas"))
        return static_cast< Canvas*>(const_cast< DrawPanel*>(this));
